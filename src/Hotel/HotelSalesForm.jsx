  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (goToList) {
          navigate("/list"); // go to hotel list page
        } else {
          ...
          <div className="facilities-container">
            <label className="checkbox-group">
              <input
                type="checkbox"
                name="wifi"
                checked={formData.facilitiesAvailable.includes('wifi')}
                onChange={handleChange}
              />
              <span>Wi-Fi</span>
            </label>
            ...
            <label className="checkbox-group">
              <input
                type="checkbox"
                name="pool"
                checked={formData.facilitiesAvailable.includes('pool')}
                onChange={handleChange}
              />
            ...
            <label className="checkbox-group">
              <input
                type="checkbox"
                name="spa"
                checked={formData.facilitiesAvailable.includes('spa')}
                onChange={handleChange}
              />
              <span>Spa</span>
            </label>
            ...
            <label className="checkbox-group">
              <input
                type="checkbox"
                name="gym"
                checked={formData.facilitiesAvailable.includes('gym')}
                onChange={handleChange}
              />
              <span>Gym</span>
            </label>
            ...
            <label className="checkbox-group">
              <input
                type="checkbox"
                name="restaurant"
                checked={formData.facilitiesAvailable.includes('restaurant')}
                onChange={handleChange}
              />
            ...
            <label className="checkbox-group">
              <input
                type="checkbox"
                name="parking"
                checked={formData.facilitiesAvailable.includes('parking')}
                onChange={handleChange}
              />
              <span>Parking</span>
            </label>
            ...
            <label className="checkbox-group">
              <input
                ...
                checked={formData.facilitiesAvailable.includes('conciergeService')}
                onChange={handleChange}
              />
            ...
            <label className="checkbox-group">
              <input
                type="checkbox"
                name="businessCenter"
                checked={formData.facilitiesAvailable.includes('businessCenter')}
                onChange={handleChange}
              />
