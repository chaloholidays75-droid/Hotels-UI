...
const SupplierForm = ({ formData, setFormData, handleChange, onSubmit, saving }) => {
  ...
  // Fix: Add null check for formData and formData.password
  ...
  useEffect(() => {
    // Fix: Add null checks for all formData properties
    const userData = {
  ...
  // Fix: Add null checks for all formData properties in validation
  const isFormValid = 
  ...
  // Fix: Add null checks for all formData values in inputs
  return (
    <div className="supplier-registration-form">
          ...
          <div className="registration-checkbox-group">
            <label className="registration-checkbox-label">
              <input
                ...
                checked={formData?.enablePaymentDetails || false}
                onChange={handleChange}
      ...
      {formData?.enablePaymentDetails && (
        <div className="registration-payment-section">
          <div className="registration-field-group">
            <label className="registration-field-label required">Bank Name</label>
            <input
              type="text"
              name="bankName"
          ...
          <div className="registration-field-group">
            <label className="registration-field-label required">Bank Account Number</label>
            <input
              type="text"
          ...
          <div className="registration-field-group">
            <label className="registration-field-label">Payment Terms</label>
            <input
              type="text"
              name="paymentTerms"
